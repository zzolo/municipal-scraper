/**
 * From: https://github.com/abbyysdk/ocrsdk.com/blob/master/JavaScript/ocrsdk.js
 */
...
ocrsdk.prototype._createTaskRequest = function(
  ...
  function getServerResponse(res) {
    if (res.statusCode >= 300) {
      taskDataCallback(
        new Error(`OCRSDK response sent a ${res.statusCode} status code.`)
      );
    }
    res.setEncoding('utf8');
    res.on('data', parseXmlResponse);
    res.on('error', taskDataCallback);
  }
